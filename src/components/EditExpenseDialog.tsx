  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>{prefT('Editar Gasto')}</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={splitType} onValueChange={(v) => setSplitType(v as typeof splitType)}>
              ...
              <SelectContent>
                ...
                <SelectItem value="percentage">{prefT('Percentual')}</SelectItem>
                <SelectItem value="full">{prefT('100% de um')}</SelectItem>
              </SelectContent>
            </Select>
          </div>
          ...
          <Button 
            ...
            className="w-full"
          >
            {isLoading ? prefT('Salvando...') : prefT('Salvar Alterações')}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
