    ...
    return (
      <div className="bg-gradient-to-br from-muted/50 to-muted rounded-3xl p-4 shadow-glass">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="font-semibold text-sm text-muted-foreground">Insights</span>
        </div>
    ...
    return (
      <div className="bg-gradient-to-br from-primary/5 to-primary/10 rounded-3xl p-4 shadow-glass">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="font-semibold text-sm">Ainda estou aprendendo...</span>
        </div>
        
        <p className="text-xs text-muted-foreground mb-3">
          Preciso de mais alguns dias para entender seus padrões e dar dicas úteis.
        </p>
        
        <div className="space-y-2">
          <div className="flex items-center justify-between text-xs">
            <span className="text-muted-foreground">Dias com gastos</span>
